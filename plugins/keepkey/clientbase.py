...
from electrum_69c.util import PrintError, UserCancelled
from electrum_69c.keystore import bip39_normalize_passphrase
from electrum_69c.bitcoin import serialize_xpub
    ...
    def callback_PassphraseRequest(self, req):
        if self.creating_wallet:
            msg = _("Enter a passphrase to generate this wallet.  Each time "
                    ...
                    "access the kh69coins in the wallet.").format(self.device)
        else:
