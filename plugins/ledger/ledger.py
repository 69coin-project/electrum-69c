...
from electrum_69c.bitcoin import TYPE_ADDRESS, int_to_hex, var_int
from electrum_69c.i18n import _
from electrum_69c.plugins import BasePlugin
...
from electrum_69c.util import print_error, is_verbose, bfh, bh2u, versiontuple
from electrum_69c.base_wizard import ScriptTypeNotSupported
...
MSG_NEEDS_FW_UPDATE_SEGWIT = _('Firmware version (or "kh69coin" app) too old for Segwit support. Please update at') + \
                      ' https://www.ledgerwallet.com'
        ...
        if not self.preflightDone:
            try:
                ...
                if (e.sw == 0x6d00 or e.sw == 0x6700):
                    raise Exception(_("Device not in kh69coin mode")) from e
                raise e
