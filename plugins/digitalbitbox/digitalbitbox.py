...
try:
    ...
    from electrum_69c.crypto import Hash, EncodeAES, DecodeAES
    from electrum_69c.bitcoin import (TYPE_ADDRESS, push_script, var_int, public_key_to_p2pkh, is_address,
                                      serialize_xpub, deserialize_xpub)
    from electrum_69c import ecc
    from electrum_69c.ecc import msg_magic
    from electrum_69c.wallet import Standard_Wallet
    from electrum_69c import constants
    from electrum_69c.transaction import Transaction
    from electrum_69c.i18n import _
    from electrum_69c.keystore import Hardware_KeyStore
    from ..hw_wallet import HW_PluginBase
    from electrum_69c.util import print_error, to_string, UserCancelled
    from electrum_69c.base_wizard import ScriptTypeNotSupported, HWD_SETUP_NEW_WALLET
...
class DigitalBitbox_Client():
    ...
    def dbb_generate_wallet(self):
        ...
        filename = ("Electrum-69c-" + time.strftime("%Y-%m-%d-%H-%M-%S") + ".pdf")
