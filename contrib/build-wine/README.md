...
These scripts can be used for cross-compilation of Windows Electrum-69c executables from Linux/Wine.
...
[that script](https://github.com/pooler/electrum-69c/blob/master/.travis.yml) might help.
...
Electrum-69c Windows builds are signed with a Microsoft Authenticode™ code signing
certificate in addition to the GPG-based signatures.

The advantage of using Authenticode is that Electrum-69c users won't receive a 
...
| Upload signatures to 'electrum-69c-signatures' repo, as `$version/$filename.$builder.asc`         |
