...
class SimpleConfig(PrintError):
    ...
    def convert_version_3(self):
        ...
        if isinstance(base_unit, str):
            ...
            map_ = {'69c':8, 'm69c':5, 'u69c':2, 'bits':2, 'sat':0}
    ...
    def get_wallet_path(self):
        ...
        old_path = os.path.join(self.path, "electrum-69c.dat")
...
def read_user_config(path):
    """Parse and store the user config settings in electrum-69c.conf into user_config[]."""
    if not path:
        return {}
