...
from electrum_69c.base_wizard import BaseWizard
from electrum_69c.util import is_valid_email
...
class RestoreSeedDialog(WizardDialog):
    ...
    def __init__(self, wizard, **kwargs):
        ...
        from electrum_69c.old_mnemonic import words as old_wordlist
