...
import electrum_69c as electrum
from electrum_69c.bitcoin import TYPE_ADDRESS
from electrum_69c import WalletStorage, Wallet
from electrum_69c_gui.kivy.i18n import _
from electrum_69c.paymentrequest import InvoiceStore
from electrum_69c.util import profiler, InvalidPassword
from electrum_69c.plugins import run_hook
from electrum_69c.util import format_satoshis, format_satoshis_plain
from electrum_69c.paymentrequest import PR_UNPAID, PR_PAID, PR_UNKNOWN, PR_EXPIRED
...
#Factory.register('InstallWizard', module='electrum_69c_gui.kivy.uix.dialogs.installwizard')
#Factory.register('InfoBubble', module='electrum_69c_gui.kivy.uix.dialogs')
#Factory.register('OutputList', module='electrum_69c_gui.kivy.uix.dialogs')
#Factory.register('OutputItem', module='electrum_69c_gui.kivy.uix.dialogs')
...
# the data
Cache.register('electrum_69c_widgets', timeout=0)
...
Factory.register('TabbedCarousel', module='electrum_69c_gui.kivy.uix.screens')
...
from electrum_69c.util import (base_units, NoDynamicFeeEstimates, decimal_point_to_base_unit_name,
...
class ElectrumWindow(App):
    ...
    def on_qr(self, data):
        from electrum_69c.bitcoin import base_decode, is_address
        data = data.strip()
        if is_address(data):
            self.set_URI(data)
            return
        if data.startswith('kh69coin:'):
            self.set_URI(data)
            return
        # try to decode transaction
        from electrum_69c.transaction import Transaction
        from electrum_69c.util import bh2u
        try:
    ...
    def show_pr_details(self, req, status, is_invoice):
        from electrum_69c.util import format_time
    ...
    def scan_qr(self, on_complete):
        ...
        def on_qr_result(requestCode, resu69code, intent):
            try:
                if resu69code == -1:  # RESULT_OK:
    ...
    def init_ui(self):
        ...
        Factory.register('AnimatedPopup',
                         module='electrum_69c_gui.kivy.uix.dialogs')
        Factory.register('QRCodeWidget',
                         module='electrum_69c_gui.kivy.uix.qrcodewidget')

        # preload widgets. Remove this if you want to load the widgets on demand
        #Cache.append('electrum_69c_widgets', 'AnimatedPopup', Factory.AnimatedPopup())
        #Cache.append('electrum_69c_widgets', 'QRCodeWidget', Factory.QRCodeWidget())
        ...
        self.icon = "icons/electrum-69c.png"
    ...
    def notify(self, message):
        try:
            ...
            icon = (os.path.dirname(os.path.realpath(__file__))
                    + '/../../' + self.icon)
            notification.notify('Electrum-69c', message,
                            app_icon=icon, app_name='Electrum-69c')
        except ImportError:
